...
Persisting per-file or per-hunk review state so a reviewer can track progress through a change set across sessions. Shares a persistence model with reviews and threads.
